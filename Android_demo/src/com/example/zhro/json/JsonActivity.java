...
public class JsonActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		clickBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(JsonActivity.this, "点击获取", 200).show();
				httpGet();
			}
		});
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(JsonActivity.this, "第 " + String.valueOf(position) + " 个被点击.", 200).show();
			}
		});
	}
	...
	private	void httpGet(){
		...
		HttpNetwork.get(url, null, new TextHttpResponseHandler(){
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				JsonActivity.this.parseXml(responseBody);
			}
	...
	private void parseXml(String in){
		...
		try {
			...
			JsonParseandInstall.parseJson(in);
			mData.add(title);
			mData.addAll(data);
		} catch (Exception e) {
			e.printStackTrace();
