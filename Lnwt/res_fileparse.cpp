...
RES_Fileparse::RES_Fileparse(QObject *parent) :
    QObject(parent)
{
}

RES_Fileparse::RES_Fileparse(QList<QStringList> fields, bool isMulti)
{
    this->ismulti = isMulti;
    this->fields = fields;
    QDir  dir(".");
    QStringList filter("*.RES");
...
void RES_Fileparse::parseFilecontext()
{
